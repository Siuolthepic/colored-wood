...
public class WoodYouDyeBlocks {
    ...
    public static final Block RED_PLANK_BUTTON = register("red_plank_button", new WoodYouDyeWoodenButtonBlock(WOOD_YOU_DYE_WOOD, 40, commonSettings().mapColor(MapColor.COLOR_RED)));
    ...
    public static final Block ORANGE_PLANK_BUTTON = register("orange_plank_button", new WoodYouDyeWoodenButtonBlock(WOOD_YOU_DYE_WOOD, 40, commonSettings().mapColor(MapColor.COLOR_ORANGE)));
    ...
    public static final Block YELLOW_PLANK_BUTTON = register("yellow_plank_button", new WoodYouDyeWoodenButtonBlock(WOOD_YOU_DYE_WOOD, 40, commonSettings().mapColor(MapColor.COLOR_YELLOW)));
    ...
    public static final Block LIME_PLANK_BUTTON = register("lime_plank_button", new WoodYouDyeWoodenButtonBlock(WOOD_YOU_DYE_WOOD, 40, commonSettings().mapColor(MapColor.COLOR_LIGHT_GREEN)));
    ...
    public static final Block GREEN_PLANK_BUTTON = register("green_plank_button", new WoodYouDyeWoodenButtonBlock(WOOD_YOU_DYE_WOOD, 40, commonSettings().mapColor(MapColor.COLOR_GREEN)));
    ...
    public static final Block BLUE_PLANK_BUTTON = register("blue_plank_button", new WoodYouDyeWoodenButtonBlock(WOOD_YOU_DYE_WOOD, 40, commonSettings().mapColor(MapColor.COLOR_BLUE)));
    ...
    public static final Block CYAN_PLANK_BUTTON = register("cyan_plank_button", new WoodYouDyeWoodenButtonBlock(WOOD_YOU_DYE_WOOD, 40, commonSettings().mapColor(MapColor.COLOR_CYAN)));
    ...
    public static final Block LIGHT_BLUE_PLANK_BUTTON = register("light_blue_plank_button", new WoodYouDyeWoodenButtonBlock(WOOD_YOU_DYE_WOOD, 40, commonSettings().mapColor(MapColor.COLOR_LIGHT_BLUE)));
    ...
    public static final Block PURPLE_PLANK_BUTTON = register("purple_plank_button", new WoodYouDyeWoodenButtonBlock(WOOD_YOU_DYE_WOOD, 40, commonSettings().mapColor(MapColor.COLOR_PURPLE)));
    ...
    public static final Block PINK_PLANK_BUTTON = register("pink_plank_button", new WoodYouDyeWoodenButtonBlock(WOOD_YOU_DYE_WOOD, 40, commonSettings().mapColor(MapColor.COLOR_PINK)));
    ...
    public static final Block MAGENTA_PLANK_BUTTON = register("magenta_plank_button", new WoodYouDyeWoodenButtonBlock(WOOD_YOU_DYE_WOOD, 40, commonSettings().mapColor(MapColor.COLOR_MAGENTA)));
    ...
    public static final Block BROWN_PLANK_BUTTON = register("brown_plank_button", new WoodYouDyeWoodenButtonBlock(WOOD_YOU_DYE_WOOD, 40, commonSettings().mapColor(MapColor.COLOR_BROWN)));
    ...
    public static final Block WHITE_PLANK_BUTTON = register("white_plank_button", new WoodYouDyeWoodenButtonBlock(WOOD_YOU_DYE_WOOD, 40, commonSettings().mapColor(MapColor.TERRACOTTA_WHITE)));
    ...
    public static final Block LIGHT_GRAY_PLANK_BUTTON = register("light_gray_plank_button", new WoodYouDyeWoodenButtonBlock(WOOD_YOU_DYE_WOOD, 40, commonSettings().mapColor(MapColor.COLOR_LIGHT_GRAY)));
    ...
    public static final Block GRAY_PLANK_BUTTON = register("gray_plank_button", new WoodYouDyeWoodenButtonBlock(WOOD_YOU_DYE_WOOD, 40, commonSettings().mapColor(MapColor.COLOR_GRAY)));
    ...
    public static final Block BLACK_PLANK_BUTTON = register("black_plank_button", new WoodYouDyeWoodenButtonBlock(WOOD_YOU_DYE_WOOD, 40, commonSettings().mapColor(MapColor.COLOR_BLACK)));
